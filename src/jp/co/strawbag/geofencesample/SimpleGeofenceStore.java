...
public class SimpleGeofenceStore {
    ...
    private static final String SHARED_PREFERENCE_NAME =
                    GeoFenceSampleActivity.class.getSimpleName();
    ...
    public SimpleGeofence getGeofence(String id) {
        ...
        String pointName = mPrefs.getString(
        		getGeofenceFieldKey(id, GeofenceUtils.KEY_POINT_NAME),
        ...
        if (
            ...
            pointName != GeofenceUtils.INVALID_STRING_VALUE) {

            // Return a true Geofence object
            return new SimpleGeofence(id, lat, lng, radius, expirationDuration, transitionType, pointName);
