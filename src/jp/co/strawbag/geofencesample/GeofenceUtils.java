...
public final class GeofenceUtils {
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.example.geofencesample.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.example.geofencesample.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.example.geofencesample.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.example.geofencesample.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.example.geofencesample.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.example.geofencesample.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.example.geofencesample.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.example.geofencesample.KEY_TRANSITION_TYPE";

    public static final String KEY_POINT_NAME =
            "com.example.geofencesample.KEY_POINT_NAME";
    
    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "com.example.geofencesample.KEY";
